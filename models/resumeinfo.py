...
class ResumeInfo(Base):
    ...
    eduinfo = Column(String(2000))
    traininginfo = Column(String(2000))
    workexpinfo = Column(String(2000))
    projectexpinfo = Column(String(2000))
    englishlevel = Column(String(100))
    japaneselevel = Column(String(100))
